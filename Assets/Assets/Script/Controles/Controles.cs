...
public partial class @Controles: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""ChangeModelCar"",
                    ""type"": ""Button"",
                    ""id"": ""9e7561d0-65a9-4607-841a-6aad55f5dcfc"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                ...
                {
                    ""name"": ""ChangeModelBall"",
                    ""type"": ""Button"",
                    ""id"": ""5e731fd9-2014-435c-925b-6864043203c9"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""59a3e2d8-59b1-4689-b3c4-b9687deacc0c"",
                    ""path"": ""<Mouse>/leftButton"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                    ""action"": ""ChangeModelCar"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                },
                {
                    ""name"": """",
                    ""id"": ""09ebf7db-a960-4ded-93d2-1bdbee9c9d6c"",
                    ""path"": ""<Mouse>/rightButton"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                    ""action"": ""ChangeModelBall"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                }
            ]
    ...
    ""controlSchemes"": []
        ...
        m_Movement_ChangeModelCar = m_Movement.FindAction("ChangeModelCar", throwIfNotFound: true);
        m_Movement_ChangeModelBall = m_Movement.FindAction("ChangeModelBall", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_Movement_ChangeModelCar;
    private readonly InputAction m_Movement_ChangeModelBall;
    public struct MovementActions
    {
        ...
        public InputAction @ChangeModelCar => m_Wrapper.m_Movement_ChangeModelCar;
        public InputAction @ChangeModelBall => m_Wrapper.m_Movement_ChangeModelBall;
        ...
        public void AddCallbacks(IMovementActions instance)
        {
            ...
            @ChangeModelCar.started += instance.OnChangeModelCar;
            @ChangeModelCar.performed += instance.OnChangeModelCar;
            @ChangeModelCar.canceled += instance.OnChangeModelCar;
            @ChangeModelBall.started += instance.OnChangeModelBall;
            @ChangeModelBall.performed += instance.OnChangeModelBall;
            @ChangeModelBall.canceled += instance.OnChangeModelBall;
        }
    ...
    public interface IMovementActions
    {
        ...
        void OnChangeModelCar(InputAction.CallbackContext context);
        void OnChangeModelBall(InputAction.CallbackContext context);
    }
}
