...
public class ColorChangerScript : MonoBehaviour
{
    ...
    [SerializeField] List<UnityEngine.Color> listaColores;
    [SerializeField] List<UnityEngine.Color> colorDash;
        ...
        while (true)
        {
            ...
            if (playerIsDashing)
            {
                while (seconds <= durationColorChangeDash)
                {
                    ...
                    transform.GetComponent<MeshRenderer>().material.color = UnityEngine.Color.Lerp(
